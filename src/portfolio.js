...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate   Frontend  Developer 🚀 having an experience of building Web  applications with JavaScript / Reactjs / typescript / firebase and some other cool libraries and frameworks."
  ),
  resumeLink:
